...
$posts = [
  [
    ...
    'description' => 'Tudo que precisa para ser um bom programador de PHP!',
  ...
  [
    'id' => 4,
    'title' => 'Estilizando em CSS',
    'description' => 'Tire todas as suas principais dúvidas sobre a programação em CSS!',
    'tags' => ['Programação', 'PHP', 'Lógica de programação'],
    'img' => 'prog-4.jpg'
  ],
];